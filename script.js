...
(function() {
  var $head, $segments, $snake, animate, audioElement, baseVelocity, getRotation, i, maxLaser, maxSnare, maxVelocity, minLength, onCanPlay, pewpew, pewpewThrottled, shootLaser, snakeRads, snakeX, snakeY, transform, transformQueue, turnDirection, velocity, whip, xMax, xMin, yMax, yMin, _i, _ref;
